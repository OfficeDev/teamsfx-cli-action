...
>[!WARNING]   
>Please note that this GitHub Action is no longer being maintained and has been archived. We recommend you follow this [guide](https://aka.ms/teamsfx-add-cicd-new) to setup CICD pipeline using CLI directly.
